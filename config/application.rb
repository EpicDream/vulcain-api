...
module VulcainApi
  class Application < Rails::Application
    ...
    config.autoload_paths += ["#{config.root}/lib/robot", "#{config.root}/lib/robot/core"]
    ...
    config.dispatcher = {
      strategies: YAML.load_file("#{Rails.root}/config/merchants.yml"),
      min_idle_vulcains: 5,
      max_idle_average: 50, # %
      running_timeout_after: 25.minutes,      
