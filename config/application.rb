...
module VulcainApi
  class Application < Rails::Application
    ...
    config.dispatcher = {
      strategies: ["AmazonFrance", "RueDuCommerce", "Fnac", "Cdiscount", "Darty", "ToysrusFrance", "EveilEtJeux", "PriceMinister", "TheBodyShopFrance", "ZalandoFR", "SuperInsolite", "TopGeek", "CadeauMaestro"],
      min_idle_vulcains: 5,
      max_idle_average: 50, # %
