...
class PriceMinisterTest < ActiveSupport::TestCase
  setup do
    ...
    @products = [
      ...
      {url: "http://www.priceminister.com/offer/buy/208348391/s1PM07071359/s2", size: 42},
      {url: "http://www.priceminister.com/offer/buy/90133660/cpl196693706/lonsdale-polo-classic-ref-10-pret-a-porter.html", color: "Jaune", size: "XXL"}
    ]
  end
