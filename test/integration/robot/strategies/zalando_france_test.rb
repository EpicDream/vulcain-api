...
class ZalandoFranceTest < StrategyTest
  ...
  PRODUCT_URL_4 = 'http://www.zalando.fr/guess-portefeuille-noir-gu152c005-802.html'
  ...
  test "finalize order with n products and m quantity" do
    expected_products = [{"price_text"=>"145,00 €", "eco_part"=>0.0, "product_title"=>"Salt & Pepper\nLIV MOOD - Lampe de table - marron", "product_image_url"=>"http://i1.ztat.net/detail/PS/87/3D/00/27/01/PS873D002-701@1.1.jpg", "price_product"=>145.0, "price_delivery"=>nil, "url"=>"http://www.zalando.fr/salt-pepper-liv-mood-lampe-de-table-marron-ps873d002-701.html", "id"=>nil, "product_version_id"=>nil, "expected_quantity"=>2, "quantity"=>2}, {"price_text"=>"115,00 €", "eco_part"=>0.0, "product_title"=>"Nordlux\nFUNK 27 - Plafonnier - noir", "product_image_url"=>"http://i1.ztat.net/detail/NL/17/3B/00/18/02/NL173B001-802@1.1.jpg", "price_product"=>115.0, "price_delivery"=>nil, "url"=>"http://www.zalando.fr/nordlux-funk-27-abat-jour-noir-nl173b001-802.html", "id"=>nil, "product_version_id"=>nil, "expected_quantity"=>3, "quantity"=>3}]
    billing = {:shipping=>0.0, :total=>635.0, :shipping_info=>"Date de livraison estimée :\nentre le lundi 23 septembre 2013 et le mercredi 25 septembre 2013\nLivraison rapide\nProtection du client\nProtection des données\nRetour sous 30 jours\nPaiement sécurisé par le protocole SSL\nLIVRAISON ET RETOUR GRATUITS"}
    products = [{url:PRODUCT_URL_1, quantity:2}, {url:PRODUCT_URL_2, quantity:3}]
