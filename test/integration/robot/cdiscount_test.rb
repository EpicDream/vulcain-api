...
class CdiscountTest < StrategyTest
  ...
  test "finalize order with n products and m quantity" do
    expected_products = [{"price_text"=>"13\n€99", "eco_part"=>0.0, "product_title"=>"Tortues Ninja - Raphael - Figurine 12cm +\naccess\nGiochi Preziosi - Tortues Ninja - Figurine 12 cm Raphael - Retrouve Raphael l'un des personnages de la série animée Tortues Ninja avec son arme... - Garçon - A partir de 3 ans - Livré à l'unité\n  Avis clients\n5,0/5 (2 avis)\nDonnez votre avisLire les avis\nPartagez le !", "product_image_url"=>"http://i2.cdscdn.com/pdt2/5/0/5/1/200x200/gio5505/rw/tortues-ninja-raphael-figurine-12cm-access.jpg", "price_product"=>13.99, "price_delivery"=>0.0, "url"=>"http://www.cdiscount.com/juniors/figurines/tortues-ninja-raphael-figurine-12cm-access/f-1206757-gio5505.html", "id"=>nil, "product_version_id"=>nil, "expected_quantity"=>2, "quantity"=>2}, {"price_text"=>"4\n€99", "eco_part"=>0.01, "product_title"=>"HP v195b USB Flash Drive 4 Go\nClé USB 4 Go - Connecteur USB rétractable - Ultra-légère : 3 grammes seulement - Compacte : 37,9 mm x 16 mm x 5 mm - Vitesse de lecture : jusqu'à 20 Mo/s - Vitesse d'écriture : jusqu'à 4 Mo/s - Com...\n  Avis clients\n5,0/5 (1 avis)\nDonnez votre avisLire les avis\nPartagez le !", "product_image_url"=>"http://i2.cdscdn.com/pdt2/b/e/f/1/200x200/fdu4gbhpv195bef/rw/hp-v195b-usb-flash-drive-4-go.jpg", "price_product"=>5.0, "price_delivery"=>0.0, "url"=>"http://www.cdiscount.com/informatique/cle-usb/hp-v195b-usb-flash-drive-4-go/f-107225309-fdu4gbhpv195bef.html", "id"=>nil, "product_version_id"=>nil, "expected_quantity"=>3, "quantity"=>3}]
    billing = {:shipping=>4.99, :total=>47.97, :shipping_info=>nil}
